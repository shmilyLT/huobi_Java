...
public class TestGetCandlestick {
	...
	private void testPeriodAndNullSize(CandlestickInterval interval, String period) {
		RestApiRequest<List<Candlestick>> restApiRequest = impl.getCandlestick("btcusdt", interval, null, null, null);
	...
	public void testNormalCase() {
		RestApiRequest<List<Candlestick>> restApiRequest = impl.getCandlestick("btcusdt", CandlestickInterval.YEAR1,
				null, null, 100);
		Request request = restApiRequest.request;
	...
	public void testResult_Normal() {
		...
		assertEquals(new BigDecimal("16424799.08415395920040605355"), candlestickList.get(0).getVolume());
		...
		assertEquals(new BigDecimal("52311364.00432444789296465098"), candlestickList.get(1).getVolume());
