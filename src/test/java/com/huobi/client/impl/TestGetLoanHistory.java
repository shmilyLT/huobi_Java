...
public class TestGetLoanHistory {
	...
	public void testRequest() {
		...
		try {
			loanOrderRequest = new LoanOrderRequest("btcusdt", sdf.parse("2019-01-02"), sdf.parse("2019-02-03"),
					LoanOrderStates.CREATED, 23456L, 123L);
		} catch (Exception e) {
	...
	public void testResult_normal() {
		...
		assertEquals(TimeService.convertCSTInMillisecondToUTC(1511169724000L), loan.get(0).getAccruedTimestamp());
		assertEquals(TimeService.convertCSTInMillisecondToUTC(1511169724530L), loan.get(0).getCreatedTimestamp());
		...
		assertEquals(TimeService.convertCSTInMillisecondToUTC(1511169724531L), loan.get(1).getAccruedTimestamp());
		assertEquals(TimeService.convertCSTInMillisecondToUTC(1511169724531L), loan.get(1).getCreatedTimestamp());
	}
