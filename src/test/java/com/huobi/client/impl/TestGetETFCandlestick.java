...
public class TestGetETFCandlestick {
	...
	private void testPeriodAndNullSize(CandlestickInterval interval, String period) {
		RestApiRequest<List<Candlestick>> restApiRequest = impl.getETFCandlestick("hb10", interval, null);
	...
	public void testNormalCase() {
		RestApiRequest<List<Candlestick>> restApiRequest = impl.getETFCandlestick("hb10", CandlestickInterval.YEAR1,
				100);
		Request request = restApiRequest.request;
