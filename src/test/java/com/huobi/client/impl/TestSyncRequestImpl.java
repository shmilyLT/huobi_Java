...
public class TestSyncRequestImpl {
	...
	public void testGetCandlestick() {
		...
		CandlestickRequest request1 = new CandlestickRequest("abc", CandlestickInterval.DAY1, null, null, 10);
		CandlestickRequest request2 = new CandlestickRequest("def", CandlestickInterval.YEAR1);
		when(restApiRequestImpl.getCandlestick(request1.getSymbol(), request1.getInterval(), request1.getStartTime(),
				request1.getEndTime(), request1.getSize())).thenReturn(restApiRequest1);
		when(restApiRequestImpl.getCandlestick(request2.getSymbol(), request2.getInterval(), request2.getStartTime(),
