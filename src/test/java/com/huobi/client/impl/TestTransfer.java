...
public class TestTransfer {
	...
	public void testRequest_transfer_in() {
		TransferRequest req = new TransferRequest("btcusdt", AccountType.SPOT, AccountType.MARGIN, "btc",
				new BigDecimal("1.1"));
	...
	public void testRequest_transfer_out() {
		TransferRequest req = new TransferRequest("btcusdt", AccountType.MARGIN, AccountType.SPOT, "ht",
				new BigDecimal("2.1"));
		RestApiRequest<Long> restApiRequest = impl.transfer(req);
		Request request = restApiRequest.request;
	...
	public void testRequest_errorAccount() {
		TransferRequest req = new TransferRequest("btcusdt", AccountType.OTC, AccountType.MARGIN, "btc",
				new BigDecimal("1.1"));
		TransferRequest request = new TransferRequest("btcusdt", null, null, "btc", new BigDecimal("1.1"));
	...
	public void testInvalidSymbol() {
		TransferRequest req = new TransferRequest("?", AccountType.SPOT, AccountType.MARGIN, "btc",
				new BigDecimal("1.1"));
		thrown.expect(HuobiApiException.class);
		impl.transfer(req);
	}
	...
	public void testInvalidCurrency() {
		TransferRequest req = new TransferRequest("htbtc", AccountType.SPOT, AccountType.MARGIN, "?",
				new BigDecimal("1.1"));
		thrown.expect(HuobiApiException.class);
		impl.transfer(req);
	}
