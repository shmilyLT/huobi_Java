...
public class TestSubTradeStatistics {
	...
	public void testRequest() {
		...
		symbols.add("btcusdt");
		WebsocketRequest<TradeStatisticsEvent> request = requestImpl.subscribe24HTradeStatisticsEvent(symbols,
				(tradeEvent) -> {
				}, null);
	...
	public void testReceive_Error() {
		...
		TradeStatisticsEvent event = request.jsonParser.parseJson(JsonWrapper.parseFromString(data_Error));
	}
}
