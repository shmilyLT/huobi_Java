...
public class TestSubscribeAccountEvent {
	...
	public void testRequest() {
		...
		WebsocketRequest<AccountEvent> request = requestImpl.subscribeAccountEvent(BalanceMode.AVAILABLE,
				(AccountEvent) -> {
				}, null);
		SubscriptionOptions options = new SubscriptionOptions();
		StubWebsocketConnection websocketConnection = new StubWebsocketConnection("aaa", "bbb", request, options);
