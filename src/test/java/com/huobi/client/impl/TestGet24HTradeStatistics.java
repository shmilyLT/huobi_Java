...
public class TestGet24HTradeStatistics {
	...
	public void testNormalCase() {
		RestApiRequest<TradeStatistics> restApiRequest = impl.get24HTradeStatistics("btcusdt");
	...
	public void testResult_Normal() {
		...
		assertEquals(TimeService.convertCSTInMillisecondToUTC(1550224944129L), tradeStatistics.getTimestamp());
