...
public class TestGetPriceDepth {
	...
	public void testNormalCase() {
		RestApiRequest<PriceDepth> restApiRequest = impl.getPriceDepth("btcusdt", null);
	...
	public void testResult_Normal() {
		RestApiRequest<PriceDepth> restApiRequest = impl.getPriceDepth("btcusdt", 1);
		...
		assertEquals(TimeService.convertCSTInMillisecondToUTC(1550218546020L), priceDepth.getTimestamp());
