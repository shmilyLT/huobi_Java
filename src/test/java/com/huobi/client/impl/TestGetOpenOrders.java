...
public class TestGetOpenOrders {
	...
	public void testRequest() {
		...
		OpenOrderRequest openOrderRequest = new OpenOrderRequest("btcusdt", AccountType.SPOT, OrderSide.BUY, 10);
	...
	public void testResult() {
		...
		assertEquals(TimeService.convertCSTInMillisecondToUTC(1550628731111L), orderList.get(0).getCreatedTimestamp());
		...
		assertEquals(TimeService.convertCSTInMillisecondToUTC(1550628730000L), orderList.get(1).getCreatedTimestamp());
	}
