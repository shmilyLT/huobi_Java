...
public class TestGetHistoricalTrade {
	...
	public void testNormalCase() {
		RestApiRequest<List<Trade>> restApiRequest = impl.getHistoricalTrade("btcusdt", "12345", null);
	...
	public void testResult_Normal() {
		RestApiRequest<List<Trade>> restApiRequest = impl.getHistoricalTrade("btcusdt", "hh", 2);
		...
		assertEquals(TimeService.convertCSTInMillisecondToUTC(1550222502562L), tradeList.get(0).getTimestamp());
