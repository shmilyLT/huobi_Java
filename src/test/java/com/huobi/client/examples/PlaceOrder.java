...
public class PlaceOrder {
	public static void main(String[] args) {
		SyncRequestClient syncRequestClient = SyncRequestClient.create("xxxxxx", "xxxxxx");
		NewOrderRequest newOrderRequest = new NewOrderRequest("htbtc", AccountType.SPOT, OrderType.SELL_LIMIT,
