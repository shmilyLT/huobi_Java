 ...
 * {@link com.huobi.client.exception.HuobiApiException} will be thrown.
 */
public interface SyncRequestClient {
	 ...
	 *
	 * @return The information of trading instrument and currencies, see
	 *         {@link ExchangeInfo}
	 */
	 ...
	 *
	 * @param symbol The symbol, like "btcusdt". (mandatory)
	 * @return The data includes last trade, best bid and best ask, see
	 *         {@link LastTradeAndBestQuote}
	 */
	 ...
	 * @return The list of candlestick/kline data, see {@link Candlestick}
	 */
	List<Candlestick> getEtfCandlestick(String etfSymbol, CandlestickInterval interval, Integer size);
	...
	static SyncRequestClient create(String apiKey, String secretKey) {
		return HuobiApiInternalFactory.getInstance().createSyncRequestClient(apiKey, secretKey, new RequestOptions());
	}
	...
	static SyncRequestClient create(String apiKey, String secretKey, RequestOptions options) {
		return HuobiApiInternalFactory.getInstance().createSyncRequestClient(apiKey, secretKey, options);
	}
}
