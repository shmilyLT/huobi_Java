...
/**
 * Asynchronous request interface, invoking Huobi RestAPI via asynchronous
 * method. All methods in this interface will return immediately, do not wait
 * the server's response. So you must implement the ResponseCallback interface
 * yourself. As long as the server response received, the onResponse callback
...
public interface AsyncRequestClient {
	 ...
	 *
	 * @param symbol   The symbol, like "btcusdt". To query hb10, put "hb10" at
	 *                 here. (mandatory)
	 * @param interval The candlestick/kline interval, MIN1, MIN5, DAY1 etc.
	 *                 (mandatory)
	 * @param size     The maximum number of candlestick/kline requested. Range [1 -
	 *                 2000] (mandatory)
	 * @param callback The callback you should implemented.
	 */
	void getLatestCandlestick(String symbol, CandlestickInterval interval, int size,
			ResponseCallback<AsyncResult<List<Candlestick>>> callback);

	/**
	 * Get the candlestick/kline for the specified symbol. The data number is 150 as
	 * default.
	 *
	 * @param request  The request for getting candlestick/kline data, see
	 *                 {@link CandlestickRequest}
	 * @param callback The callback you should implemented.
	 */
	void getCandlestick(CandlestickRequest request, ResponseCallback<AsyncResult<List<Candlestick>>> callback);

	/**
	 * Get the timestamp from Huobi server. The timestamp is the Unix timestamp in
	 * millisecond.<br>
	 * The count shows how many milliseconds passed from Jan 1st 1970, 00:00:00.000
	 * at UTC.<br>
	 * <br>
	 ...
	 * @param size     The maximum number of Market Depth requested. range [1 - 150]
	 *                 (mandatory)
	 * @param callback The callback you should implemented.
	 */
	 ...
	 *
	 * @param symbol   The symbol, like "btcusdt". (mandatory)
	 * @param size     The number of historical trade requested, range [1 - 2000]
	 *                 (mandatory)
	 * @param callback The callback you should implemented.
	 */
	void getHistoricalTrade(String symbol, int size, ResponseCallback<AsyncResult<List<Trade>>> callback);
	 ...
	 * @param callback The callback you should implemented.
	 */
	void get24HTradeStatistics(String symbol, ResponseCallback<AsyncResult<TradeStatistics>> callback);

	/**
	 * Get all the trading assets and currencies supported in huobi. The information
	 * of trading instrument, including base currency, quote precision, etc.
	 *
	 * @param callback The callback you should implemented.
	 */
	 ...
	 * @param callback The callback you should implemented.
	 */
	void getWithdrawHistory(String currency, long fromId, int size,
	 ...
	 * @param callback The callback you should implemented.
	 */
	void getDepositHistory(String currency, long fromId, int size,
	 ...
	 *
	 * @param symbol   The trading symbol to borrow margin, e.g. "btcusdt",
	 *                 "bccbtc". (mandatory)
	 * @param currency The currency to borrow,like "btc". (mandatory)
	 * @param amount   The amount of currency to borrow. (mandatory)
	 * @param callback The callback you should implemented.
	 */
	void applyLoan(String symbol, String currency, BigDecimal amount, ResponseCallback<AsyncResult<Long>> callback);

	/**
	 * Repay margin loan with you asset in your margin account.
	 *
	 * @param loadId   The previously returned order id when loan order was created.
	 *                 (mandatory)
	 ...
	 *
	 * @param loanOrderRequest The information of order request, including symbol,
	 *                         start-date, end-date etc, see
	 *                         {@link LoanOrderRequest}
	 * @param callback         The callback you should implemented.
	 */
	void getLoanHistory(LoanOrderRequest loanOrderRequest, ResponseCallback<AsyncResult<List<Loan>>> callback);
	 ...
	 * @param callback The callback you should implemented.
	 */
	void getLastTradeAndBestQuote(String symbol, ResponseCallback<AsyncResult<LastTradeAndBestQuote>> callback);
	 ...
	 *
	 * @param newOrderRequest The request of an order ,including account-id,amount ,
	 *                        price ,etc.
	 * @param callback        The callback you should implemented.
	 */
	...
	/**
	 * Provide open orders of a symbol for an account<br>
	 * When neither account-id nor symbol defined in the request, the system will
	 * return all open orders (max 500) for all symbols and all accounts of the
	 * user, sorted by order ID in descending.
	 *
	 * @param openOrderRequest open order request
	 * @param callback         The callback you should implemented.
	 */
	void getOpenOrders(OpenOrderRequest openOrderRequest, ResponseCallback<AsyncResult<List<Order>>> callback);
	 ...
	 * @param callback The callback you should implemented.
	 */
	void cancelOrders(String symbol, List<Long> orderIds, ResponseCallback<AsyncResult<Void>> callback);
	 ...
	 * @param callback The callback you should implemented.
	 */
	void cancelOpenOrders(CancelOpenOrderRequest request, ResponseCallback<AsyncResult<BatchCancelResult>> callback);
	 ...
	 * @param callback The callback you should implemented.
	 */
	void getMatchResults(String symbol, long orderId, ResponseCallback<AsyncResult<List<MatchResult>>> callback);

	/**
	 * Search for the trade records of an account
	 *
	 * @param matchResultRequest A specific account information, including symbols,
	 *                           types etc.
	 * @param callback           The callback you should implemented.
	 */
	void getMatchResults(MatchResultRequest matchResultRequest,
	 ...
	 * @param callback   The callback you should implemented.
	 */
	void cancelWithdraw(String currency, long withdrawId, ResponseCallback<AsyncResult<Void>> callback);
	 ...
	 * @param callback The callback you should implemented.
	 */
	void getHistoricalOrders(HistoricalOrdersRequest req, ResponseCallback<AsyncResult<List<Order>>> callback);
	...
	void transferBetweenParentAndSub(TransferMasterRequest req, ResponseCallback<AsyncResult<Long>> callback);
	 ...
	 * @param callback The callback you should implemented.
	 */
	void getCurrentUserAggregatedBalance(ResponseCallback<AsyncResult<List<Balance>>> callback);
	 ...
	 * @param callback The callback you should implemented.
	 */
	void getSpecifyAccountBalance(long subId, ResponseCallback<AsyncResult<List<CompleteSubAccountInfo>>> callback);

	/**
	 * Get the basic information of ETF creation and redemption, as well as ETF
	 * constituents, including max amount of creation, min amount of creation, max
	 * amount of redemption, min amount of redemption, creation fee rate, redemption
	 * fee rate, eft create/redeem status.
	 *
	 ...
	 * @param swapType  The swap type to indicate creation or redemption, see
	 *                  {@link EtfSwapType} (mandatory)
	 * @param callback  The callback you should implemented.
	 */
	void etfSwap(String etfSymbol, int amount, EtfSwapType swapType, ResponseCallback<AsyncResult<Void>> callback);

	/**
	 * Get past creation and redemption.(up to 100 records)
	 *
	 * @param etfSymbol The symbol, currently only support hb10. (mandatory)
	 * @param offset    The offset of the records, set to 0 for the latest records.
	 *                  (mandatory)
	 * @param size      The number of records to return, the range is [1, 100].
	 *                  (mandatory)
	 * @param callback  The callback you should implemented.
	 */
	 ...
	 * @param interval  The candlestick/kline interval, MIN1, MIN5, DAY1 etc.
	 *                  (mandatory)
	 * @param limit     The maximum number of candlestick/kline requested. Range [1
	 *                  - 2000] (optional)
	 * @param callback  The callback you should implemented.
	 */
	void getEtfCandlestick(String etfSymbol, CandlestickInterval interval, Integer limit,
			ResponseCallback<AsyncResult<List<Candlestick>>> callback);

	/**
	 * Create the asynchronous client. All interfaces defined in asynchronous client
	 * are implemented by asynchronous mode.
	 *
	...
	static AsyncRequestClient create(String apiKey, String secretKey) {
		return HuobiApiInternalFactory.getInstance().createAsyncRequestClient(apiKey, secretKey, new RequestOptions());
	}
	...
	static AsyncRequestClient create(String apiKey, String secretKey, RequestOptions options) {
		return HuobiApiInternalFactory.getInstance().createAsyncRequestClient(apiKey, secretKey, options);
	}
}
