...
public class AccountChange {
	...
	/**
	 * Get the balance after the change. If the {@link BalanceMode} in
	 * {@link com.huobi.client.SubscriptionClient#subscribeAccountEvent(BalanceMode, SubscriptionListener)}
	 * is AVAILABLE, the balance refers to available balance. If the
	 * {@link BalanceMode} is TOTAL, the balance refers to total balance for trade
	 * sub account (available+frozen)
	 *
