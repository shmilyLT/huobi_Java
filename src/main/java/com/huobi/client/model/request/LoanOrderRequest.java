...
public class LoanOrderRequest {
	 ...
	 * @param states    The loan order states, it could be created, accrual, cleared
	 *                  or invalid (optional, can be null).
	 ...
	 */
	public LoanOrderRequest(String symbol, Date startDate, Date endDate, LoanOrderStates states, Long fromId,
			Long size) {
		this.symbol = symbol;
