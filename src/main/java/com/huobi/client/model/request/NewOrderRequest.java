...
public class NewOrderRequest {
	 ...
	 * @param amount      The amount to buy (quote currency) or to sell (base
	 *                    currency). (mandatory)
	 * @param price       The limit price of limit order, only needed for limit
	 *                    order. (mandatory for buy-limit, sell-limit,
	 *                    buy-limit-maker and sell-limit-maker)
	 */
