...
public class MatchResultRequest {
	 ...
	 *
	 * @param symbol    The symbol, like "btcusdt" (mandatory).
	 * @param type      The types of order to include in the search (optional, can
	 *                  be null).
	 * @param startDate Search starts date (optional, can be null).
	 * @param endDate   Search ends date (optional, can be null).
	 * @param size      The number of orders to return, range [1-100] default is
	 *                  100. (optional, can be null).
	 * @param from      Search order id to begin with. (optional, can be null).
	 */
	public MatchResultRequest(String symbol, OrderType type, Date startDate, Date endDate, Integer size, String from) {
		this.symbol = symbol;
		this.type = type;
