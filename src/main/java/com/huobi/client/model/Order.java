...
public class Order {
	...
	/**
	 * Get the UNIX formatted timestamp in UTC when the order was canceled, if not
	 * canceled then has value of 0.
	 *
	 * @return The timestamp
	 */
	...
	/**
	 * Get the UNIX formatted timestamp in UTC when the order was changed to a final
	 * state. This is not the time the order is matched.
	 *
	 * @return The timestamp
	 */
	...
	/**
	 * Get the order type, possible values are: buy-market, sell-market, buy-limit,
	 * sell-limit, buy-ioc, sell-ioc, buy-limit-maker, sell-limit-maker.
	 *
	...
	/**
	 * Get the source where the order was triggered, possible values: sys, web, api,
	 * app.
	 *
