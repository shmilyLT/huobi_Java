...
public class WebSocketConnection extends WebSocketListener {
	...
	WebSocketConnection(String apiKey, String secretKey, SubscriptionOptions options, WebsocketRequest request,
		...
		this.okhttpRequest = request.authHandler == null ? new Request.Builder().url(subscriptionMarketUrl).build()
	...
	private void onError(String errorMessage, Throwable e) {
		if (request.errorHandler != null) {
			HuobiApiException exception = new HuobiApiException(HuobiApiException.SUBSCRIPTION_ERROR, errorMessage, e);
	...
	public void onOpen(WebSocket webSocket, Response response) {
		...
		if (request.authHandler != null) {
			...
			builder.putToUrl(ApiSignature.op, ApiSignature.opValue).putToUrl("cid", TimeService.getCurrentTimeStamp());
