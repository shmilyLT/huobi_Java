...
public class UrlParamsBuilder {
	...
	class ParamsMap {
		...
		void put(String name, String value) {
			...
			if (name == null || "".equals(name)) {
				throw new HuobiApiException(HuobiApiException.RUNTIME_ERROR, "[URL] Key can not be null");
			}
	...
	private static String urlEncode(String s) {
		try {
			...
			throw new HuobiApiException(HuobiApiException.RUNTIME_ERROR, "[URL] UTF-8 encoding not supported!");
		}
	}
}
