...
public class JsonWrapper {
	...
	public static JsonWrapper parseFromString(String text) {
		try {
			...
			throw new HuobiApiException(HuobiApiException.RUNTIME_ERROR, "[Json] Fail to parse json: " + text);
		} catch (Exception e) {
	...
	public JsonWrapperArray getJsonArray(String name) {
		...
		try {
			...
			throw new HuobiApiException(HuobiApiException.RUNTIME_ERROR, "[Json] Get array: " + name + " error");
		}
		if (array == null) {
			throw new HuobiApiException(HuobiApiException.RUNTIME_ERROR, "[Json] Array: " + name + " does not exist");
		}
