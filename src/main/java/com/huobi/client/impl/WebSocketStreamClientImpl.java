...
public class WebSocketStreamClientImpl implements SubscriptionClient {
	...
	public void subscribeCandlestickEvent(String symbols, CandlestickInterval interval,
		...
		createConnection(requestImpl.subscribeCandlestickEvent(parseSymbols(symbols), interval, subscriptionListener,
				errorHandler));
	}

	@Override
	public void subscribePriceDepthEvent(String symbols, SubscriptionListener<PriceDepthEvent> subscriptionListener) {
	...
	public void subscribePriceDepthEvent(String symbols, SubscriptionListener<PriceDepthEvent> subscriptionListener,
		...
		createConnection(
				requestImpl.subscribePriceDepthEvent(parseSymbols(symbols), subscriptionListener, errorHandler));
	}

	@Override
	public void subscribeTradeEvent(String symbols, SubscriptionListener<TradeEvent> subscriptionListener) {
	...
	public void subscribeTradeEvent(String symbols, SubscriptionListener<TradeEvent> subscriptionListener,
			SubscriptionErrorHandler errorHandler) {
		createConnection(requestImpl.subscribeTradeEvent(parseSymbols(symbols), subscriptionListener, errorHandler));
	}

	@Override
	public void subscribeOrderUpdateEvent(String symbols, SubscriptionListener<OrderUpdateEvent> subscriptionListener) {
	...
	public void subscribeOrderUpdateEvent(String symbols, SubscriptionListener<OrderUpdateEvent> subscriptionListener,
			SubscriptionErrorHandler errorHandler) {
		createConnection(
				requestImpl.subscribeOrderUpdateEvent(parseSymbols(symbols), subscriptionListener, errorHandler));
	}
	...
	@Override
	public void subscribeAccountEvent(BalanceMode mode, SubscriptionListener<AccountEvent> subscriptionListener) {
	...
	public void subscribe24HTradeStatisticsEvent(String symbols,
		...
		createConnection(requestImpl.subscribe24HTradeStatisticsEvent(parseSymbols(symbols), subscriptionListener,
				errorHandler));
	}
}
