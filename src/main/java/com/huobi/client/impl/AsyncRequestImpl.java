...
public class AsyncRequestImpl implements AsyncRequestClient {
	...
	public void getLatestCandlestick(String symbol, CandlestickInterval interval, int size,
		...
		RestApiInvoker.callASync(requestImpl.getCandlestick(symbol, interval, null, null, size), callback);
	}

	@Override
	public void getCandlestick(CandlestickRequest request, ResponseCallback<AsyncResult<List<Candlestick>>> callback) {
		RestApiInvoker.callASync(requestImpl.getCandlestick(request.getSymbol(), request.getInterval(),
				request.getStartTime(), request.getEndTime(), request.getSize()), callback);
	}
	...
	@Override
	public void getPriceDepth(String symbol, int size, ResponseCallback<AsyncResult<PriceDepth>> callback) {
	...
	@Override
	public void getHistoricalTrade(String symbol, int size, ResponseCallback<AsyncResult<List<Trade>>> callback) {
		RestApiInvoker.callASync(requestImpl.getHistoricalTrade(symbol, null, size), callback);
	}

	@Override
	public void get24HTradeStatistics(String symbol, ResponseCallback<AsyncResult<TradeStatistics>> callback) {
	...
	@Override
	public void transfer(TransferRequest transferRequest, ResponseCallback<AsyncResult<Long>> callback) {
	...
	@Override
	public void repayLoan(long loadId, BigDecimal amount, ResponseCallback<AsyncResult<Long>> callback) {
		RestApiInvoker.callASync(requestImpl.repayLoan(loadId, amount), callback);
	}

	@Override
	public void getLoanHistory(LoanOrderRequest loanOrderRequest, ResponseCallback<AsyncResult<List<Loan>>> callback) {
		RestApiInvoker.callASync(requestImpl.getLoan(loanOrderRequest), callback);
	}

	@Override
	public void getLastTradeAndBestQuote(String symbol, ResponseCallback<AsyncResult<LastTradeAndBestQuote>> callback) {
	...
	@Override
	public void getAccountBalance(AccountType accountType, ResponseCallback<AsyncResult<Account>> callback) {
		RestApiInvoker.callASync(requestImpl.getAccounts(), (accountResult) -> {
			if (accountResult.succeeded()) {
	...
	@Override
	public void createOrder(NewOrderRequest newOrderRequest, ResponseCallback<AsyncResult<Long>> callback) {
		RestApiInvoker.callASync(requestImpl.createOrder(newOrderRequest), callback);
	}

	@Override
	public void getOpenOrders(OpenOrderRequest openOrderRequest, ResponseCallback<AsyncResult<List<Order>>> callback) {
		RestApiInvoker.callASync(requestImpl.getOpenOrders(openOrderRequest), callback);
	}

	@Override
	public void cancelOrder(String symbol, long orderId, ResponseCallback<AsyncResult<Void>> callback) {
		RestApiInvoker.callASync(requestImpl.cancelOrder(symbol, orderId), callback);
	}

	@Override
	public void cancelOrders(String symbol, List<Long> orderIds, ResponseCallback<AsyncResult<Void>> callback) {
	...
	@Override
	public void withdraw(WithdrawRequest withdrawRequest, ResponseCallback<AsyncResult<Long>> callback) {
		RestApiInvoker.callASync(requestImpl.withdraw(withdrawRequest), callback);
	}

	@Override
	public void cancelWithdraw(String currency, long withdrawId, ResponseCallback<AsyncResult<Void>> callback) {
		RestApiInvoker.callASync(requestImpl.cancelWithdraw(currency, withdrawId), callback);
	}

	@Override
	public void getHistoricalOrders(HistoricalOrdersRequest req, ResponseCallback<AsyncResult<List<Order>>> callback) {
		RestApiInvoker.callASync(requestImpl.getHistoricalOrders(req), callback);
	}

	@Override
	public void transferBetweenParentAndSub(TransferMasterRequest req, ResponseCallback<AsyncResult<Long>> callback) {
	...
	@Override
	public void getEtfSwapConfig(String etfSymbol, ResponseCallback<AsyncResult<EtfSwapConfig>> callback) {
